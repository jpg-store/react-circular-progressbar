...
function Path(_a) {
    ...
    return (createElement("path", { className: className, style: Object.assign({}, style, __assign(__assign({}, dashStyles), (striped && { stroke: 'url(#striped)' }))), d: getPathDescription({
...
function StripPattern(_a) {
    ...
    return (createElement("defs", null,
        createElement("pattern", { id: "striped", width: "3", height: "10", patternUnits: "userSpaceOnUse", patternTransform: "rotate(40 50 50)" },
            createElement("rect", { x: "0", y: "0", width: "100%", height: "100%", fill: fill }),
            createElement("line", { stroke: stroke, strokeWidth: "2px", y2: "10" }))));
}
...
var CircularProgressbar = (function (_super) {
    ...
    CircularProgressbar.prototype.render = function () {
        ...
        return (createElement("svg", { className: classes.root + " " + className, style: styles.root, viewBox: "0 0 " + VIEWBOX_WIDTH + " " + VIEWBOX_HEIGHT, "data-test-id": "CircularProgressbar" },
            striped && createElement(StripPattern, { style: styles.strip }),
            ...
            createElement(Path, { className: classes.path, counterClockwise: counterClockwise, dashRatio: pathRatio * circleRatio, pathRadius: pathRadius, strokeWidth: strokeWidth, striped: striped, style: styles.path }),
